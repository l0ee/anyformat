...
export const Footer: React.FC = () => {
  return (
    <footer className="max-w-7xl mx-4 sm:mx-6 lg:mx-auto my-8 rounded-[2.5rem] border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl text-slate-600 dark:text-slate-400 p-8 sm:p-12 shadow-xl transition-colors font-['Plus_Jakarta_Sans',sans-serif]">
      <div className="max-w-7xl mx-auto px-2">
        <div className="grid grid-cols-1 gap-8 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <section aria-labelledby="footer-about" className="space-y-3">
            <h2 id="footer-about" className="text-xs font-semibold uppercase tracking-wider text-slate-900 dark:text-slate-200">About us</h2>
          ...
          <section aria-labelledby="footer-vector-tools">
            <h2 id="footer-vector-tools" className="text-xs font-semibold uppercase tracking-wider text-slate-900 dark:text-slate-200 mb-3">Vector tools</h2>
          ...
          <section aria-labelledby="footer-format-tools">
            <h2 id="footer-format-tools" className="text-xs font-semibold uppercase tracking-wider text-slate-900 dark:text-slate-200 mb-3">Format tools</h2>
            <ul className="space-y-2 text-xs">
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-500">
